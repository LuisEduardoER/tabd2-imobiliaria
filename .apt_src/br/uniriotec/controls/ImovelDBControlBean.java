...
public class ImovelDBControlBean
extends org.apache.beehive.controls.system.jdbc.JdbcControlBean
implements br.uniriotec.controls.ImovelDBControl
{
    ...
    */
    public ImovelDBControlBean(ControlBeanContext context, String id, PropertyMap props)
    {
        this(context, id, props, br.uniriotec.controls.ImovelDBControl.class);
    }
    ...
    */
    protected ImovelDBControlBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
    ...
    */
    ...
    /**
    * Implements br.uniriotec.controls.ImovelDBControl.getImoveis
    */
    public  br.uniriotec.beans.Imovel[] getImoveis(java.lang.String p_where, java.lang.String p_orderby) throws java.sql.SQLException
    {
        Object [] __bc_argArray = new Object[] { p_where, p_orderby };
        Throwable __bc_thrown = null;
        Extensible __bc_target = (Extensible)ensureControl();
        br.uniriotec.beans.Imovel[] __bc_retval = null;
        
        try
        {
            preInvoke(_getImoveisMethod, __bc_argArray);
            
            __bc_retval =
            (br.uniriotec.beans.Imovel[])
            __bc_target.invoke(_getImoveisMethod, __bc_argArray)
            ;
        }
        catch (Throwable __bc_t)
        {
            ...
            else if (__bc_t instanceof java.sql.SQLException) throw (java.sql.SQLException)__bc_t;
        ...
        finally
        {
            ...
            postInvoke(_getImoveisMethod, __bc_argArray, __bc_rv, __bc_thrown);
        }
        return __bc_retval;
    }
